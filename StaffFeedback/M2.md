...
You qualified for a Yellow Belt 🥋🟡 and got a final grade of 4.05/6 for M2. Good start! Keep practicing to improve. 
...
|------------------------------------------|--------------------------------|------------|-------------------------------------------|
| **Implementation (APK, code quality)**   | 4.04 out of 6 | 40%        | [See Details](#implementation-apk-code-quality) |
| **Features**                             | 3.66 out of 6   | 20%        | [See Details](#features)                  |
...
| **Scrum Process (documents, autonomy)**  | 4 out of 6 | 10%       | [See Details](#scrum-process-documents-autonomy) |
| **Consistent Delivery of Value**         | 4 out of 6 | 10%      | [See Details](#consistent-delivery-of-value) |
| **Final Grade**                          | **4.05 out of 6**   |            |                                           |
...
The APK have no usable features apart from the speech-to-text.

Only 1 meaningful end-to-end found


The codebase contain some severe code smell, see the sonarcloud analysis for futher details.
Consider introducing a components folder to better distinguish between screens and reusable UI elements. 
...
For this part, you received 4.04 points out of a maximum of 6.
...
Features work during the demo however fail to work in the production APK. 

For this part, you received 3.66 points out of a maximum of 6.
...
Your Figma is not ahead of your app. Aim to develop features in design first, and then implement them in code.

Nitpik for architecture diagram: no name for the audio api
 used
...
Missing Spint task : only 36 hours of work was planned
Missing criticial issue : No deployement of Edge Function is planned.
...
Missing second Stand-Up for week S3 and S4

The team should adhere more to the SCRUM process and fully embrace the roles of scrum master and product owner

Aim to be more prepared for the demo, it should be seamless
...
Aim to improve team coherence so that everyone stays aware of the app’s progress and can deliver more complete and stable features.

For this part, you received 4 points out of a maximum of 6.

## Summary

Your team grade for milestone M2 is 4.05/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
