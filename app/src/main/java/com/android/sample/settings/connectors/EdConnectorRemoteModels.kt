...
/**
 * Modèle "remote" pour la config ED telle que renvoyée par les callables.
 * C’est ce type qu’on utilise dans le ViewModel / UI.
 */
...
/**
 * Mapping brut Any? -> EdConnectorConfigRemote à partir de result.data
 * des fonctions Firebase.
 */
