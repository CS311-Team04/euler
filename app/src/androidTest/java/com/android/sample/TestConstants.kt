...
/** Shared constants for Android instrumented tests */
object TestConstants {
  ...
  object ContentDescriptions {
    ...
    const val EULER_LOGO = "Euler Logo"
  ...
  object PlaceholderTexts {
    const val MESSAGE_EULER = "Message EULER"
  }

  // Footer texts
  object FooterTexts {
    const val POWERED_BY = "Powered by APERTUS Swiss LLM · MCP-enabled for 6 EPFL systems"
  }
