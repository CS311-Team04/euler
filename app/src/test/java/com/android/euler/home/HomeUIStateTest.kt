...
class HomeUIStateTest {
    ...
    fun `HomeUiState should support copy with modifications`() {
        ...
        val multiModifiedState = originalState.copy(
        ...
        assertEquals("Multiple properties should be modified", "Multi Modified User", multiModifiedState.userName)
        ...
        assertEquals("MessageDraft should be modified", "Modified message", multiModifiedState.messageDraft)
    ...
    fun `SystemItem should support copy with modifications`() {
        ...
        val modifiedSystem = originalSystem.copy(
            id = "modified-id",
    ...
    fun `ActionItem should support copy with modifications`() {
        ...
        val modifiedAction = originalAction.copy(
            id = "modified-id",
        ...
        assertEquals("Original title should remain", "Original Action", partiallyModifiedAction.title)
    ...
    fun `ActionItem should handle edge cases`() {
        ...
        val longTitle = "Very Long Action Title That Might Be Generated By The System In Real Scenarios"
    ...
    fun `data classes should have proper toString representation`() {
        ...
        assertTrue("Action toString should contain title", action.toString().contains("Test Action"))
    ...
    fun `data classes should have proper hashCode`() {
        ...
        assertEquals("Same systems should have same hashCode", system1.hashCode(), system2.hashCode())
        assertNotEquals("Different systems should have different hashCode", system1.hashCode(), system3.hashCode())
        ...
        assertEquals("Same actions should have same hashCode", action1.hashCode(), action2.hashCode())
        assertNotEquals("Different actions should have different hashCode", action1.hashCode(), action3.hashCode())
    }
}
