...
class MicrosoftAuthJwtTest {
    ...
    private val testJwtWithTenant = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwidGlkIjoiZTBiY2QwNy03MjE0LTQxNmItOTY3Ni1mOWRhYzMxNTI1MDciLCJpYXQiOjE1MTYyMzkwMjJ9.signature"

    // Test JWT sans tenant ID
    private val testJwtWithoutTenant = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.signature"
    ...
    fun `extractTenantIdFromJwt should handle JWT without tenant ID`() {
        ...
        assertTrue("Should return null or empty string when no tenant ID", 
