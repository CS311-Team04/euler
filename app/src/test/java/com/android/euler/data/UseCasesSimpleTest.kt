...
class UseCasesSimpleTest {
    ...
    fun `UseCases functions should have correct signatures`() {
        ...
        try {
            ...
            if (ensureProfileMethod != null) {
                ...
                assertTrue("ensureProfile should have parameters", 
            ...
            if (logRagMethod != null) {
                ...
                assertTrue("logRag should have parameters", 
                    logRagMethod.parameterCount > 0)
            }
    ...
    fun `UseCases should handle class loading`() {
        ...
        try {
            ...
            assertEquals("Should have correct name", "com.android.sample.data.UseCasesKt", clazz.name)
