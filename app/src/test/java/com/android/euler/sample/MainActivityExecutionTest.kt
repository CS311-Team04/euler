...
class MainActivityExecutionTest {
    ...
    fun `MainActivity should be accessible and instantiable`() {
        ...
        try {
            ...
            assertTrue("MainActivity should extend Activity", Activity::class.java.isAssignableFrom(mainActivityClass))
    ...
    fun `MainActivity should handle savedInstanceState`() {
        ...
        try {
            ...
            assertEquals("SavedInstanceState should contain test value", "test_value", savedInstanceState.getString("test_key"))
