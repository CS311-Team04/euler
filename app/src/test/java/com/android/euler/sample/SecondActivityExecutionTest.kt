...
class SecondActivityExecutionTest {
    ...
    fun `SecondActivity should be accessible and instantiable`() {
        ...
        try {
            ...
            assertTrue("SecondActivity should extend Activity", Activity::class.java.isAssignableFrom(secondActivityClass))
            
            // Créer une instance de SecondActivity
            val secondActivity = Robolectric.buildActivity(SecondActivity::class.java).create().get()
    ...
    fun `SecondActivity should handle savedInstanceState`() {
        ...
        try {
            ...
            assertEquals("SavedInstanceState should contain test value", "second_activity_value", savedInstanceState.getString("second_activity_key"))
    ...
    fun `SecondActivity should handle activity lifecycle states`() {
        ...
        try {
            ...
            assertNotNull("SecondActivity should be created", secondActivity)
            assertFalse("SecondActivity should not be finishing initially", secondActivity.isFinishing)
    ...
    fun `SecondActivity should handle activity state persistence`() {
        ...
        try {
            ...
            assertEquals("OutState should contain persisted state", "persisted_state", outState.getString("second_activity_state"))
