...
class HomeViewModelTest {
  ...
  @Test
  fun `initial state contains exactly 6 systems`() {
    val vm = HomeViewModel()
    val state = vm.uiState.value
  ...
  @Test
  fun `initial state contains exactly 3 recent actions`() {
    val vm = HomeViewModel()
    val state = vm.uiState.value
  ...
  @Test
  fun `toggleDrawer flips drawer state`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `multiple toggleDrawer calls alternate correctly`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `setTopRightOpen sets explicit value`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `setTopRightOpen can be called multiple times with same value`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `updateMessageDraft updates text`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `updateMessageDraft can handle empty string`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `updateMessageDraft can handle long text`() {
    val vm = HomeViewModel()
    val longText =
  ...
  @Test
  fun `updateMessageDraft can handle special characters`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `sendMessage appends new action and clears draft`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `sendMessage with blank draft does nothing`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `sendMessage multiple times adds multiple actions`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `sendMessage preserves previous actions order`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `toggleSystemConnection flips the flag of targeted system`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `toggleSystemConnection with connected system disconnects it`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `toggleSystemConnection does not affect other systems`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `toggleSystemConnection with non-existent id does nothing`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `toggleSystemConnection multiple times for same system`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `setLoading sets explicit loading state`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `setLoading can be called multiple times with same value`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `all operations preserve other state values`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `sendMessage trims whitespace but preserves content`() {
    val vm = HomeViewModel()
    val initialSize = vm.uiState.value.recent.size
  ...
  @Test
  fun `initial state system names are correct`() {
    val vm = HomeViewModel()
    val state = vm.uiState.value
  ...
  @Test
  fun `initial state system connection states are correct`() {
    val vm = HomeViewModel()
    val state = vm.uiState.value
  ...
  @Test
  fun `initial state recent actions have valid UUIDs`() {
    val vm = HomeViewModel()
    val state = vm.uiState.value
  ...
  @Test
  fun `sendMessage creates action with correct format`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `updateMessageDraft handles null-like values`() {
    val vm = HomeViewModel()
  ...
  @Test
  fun `toggleSystemConnection with multiple systems preserves others`() {
    val vm = HomeViewModel()
