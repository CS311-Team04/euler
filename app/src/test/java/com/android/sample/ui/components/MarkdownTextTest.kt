...
/**
 * Unit tests for the MarkdownText composable.
...
class MarkdownTextTest {
    ...
    fun markdownText_rendersBoldText() {
        composeRule.setContent {
            MarkdownText(markdown = "This is **bold** text")
        }
    ...
    fun markdownText_rendersBulletList() {
        composeRule.setContent {
            MarkdownText(markdown = "- Item 1\n- Item 2\n- Item 3")
        }

        composeRule.onNodeWithText("Item 1", substring = true, useUnmergedTree = true).assertIsDisplayed()
        composeRule.onNodeWithText("Item 2", substring = true, useUnmergedTree = true).assertIsDisplayed()
    }

    @Test
    fun simpleMarkdownText_rendersPlainText() {
        composeRule.setContent {
            SimpleMarkdownText(text = "Simple text here")
        }
    ...
    fun simpleMarkdownText_rendersBoldText() {
        composeRule.setContent {
            SimpleMarkdownText(text = "This is **bold** text")
        }
    ...
    fun simpleMarkdownText_rendersItalicText() {
        composeRule.setContent {
            SimpleMarkdownText(text = "This is *italic* text")
        }
    ...
    fun simpleMarkdownText_rendersInlineCode() {
        composeRule.setContent {
            SimpleMarkdownText(text = "Use `code` here")
        }
