...
class AuthCoverageVerificationTest {
    ...
    fun `verify all auth classes are testable`() {
        ...
        assertTrue("NetworkHelper should be testable", NetworkHelper.isConnected(true, true, false, false))
        assertFalse("NetworkHelper should be testable", NetworkHelper.isConnected(false, false, false, false))
