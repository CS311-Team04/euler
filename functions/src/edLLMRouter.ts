...
const ED_CATEGORY_SYSTEM_PROMPT = [
  ...
  "",
  "CRITICAL RULES FOR CONSERVATIVE CATEGORY SELECTION:",
  "",
  "1. Prefer \"General\" or \"none\" for vague queries:",
  "   - If the query is about exam format, general course questions, logistics, announcements, or broad topics,",
  "     return \"General\" for chosenCategory (or \"none\" if \"General\" is not available).",
  "   - Do NOT pick specific exercise/module categories unless the user explicitly mentions them.",
  "",
  "2. Only pick specific categories when explicit hints are present:",
  "   - Exercise/problem set hints: \"ps\", \"ps5\", \"problem set\", \"sheet\", \"series\", \"exo\", \"exercise\"",
  "   - Homework/assignment hints: \"homework\", \"hw\", \"assignment\"",
  "   - Module hints: \"module 1\", \"module 2\", etc.",
  "   - If these hints are present, you may choose the matching category (e.g., \"Exercises\", \"Problem Sets\", \"Homeworks\", \"Modules\").",
  "",
  "3. Subcategory selection:",
  "   - Only set chosenSubcategory if there is a VERY clear match (e.g., \"HW2\", \"Assignment 4\", \"Module 6\").",
  "   - If no subcategory clearly matches, set chosenSubcategory to \"none\".",
  "",
  "4. When in doubt:",
  "   - Prefer \"General\" or \"none\" over a weak match.",
  "   - It's better to search across all categories than to over-filter with a wrong category.",
  "",
  "5. Format requirements:",
  "   - The chosenCategory must match EXACTLY one of the category names in the input (case-sensitive), or \"none\".",
  ...
  "{",
  '  "chosenCategory": "<exact category name>" | "General" | "none",',
