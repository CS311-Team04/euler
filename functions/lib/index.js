...
exports.getEpflScheduleStatusFn = exports.disconnectEpflScheduleFn = exports.syncEpflScheduleFn = exports.getScheduleContextCore = exports.syncEpflScheduleCore = exports.connectorsMoodleTestFn = exports.connectorsMoodleDisconnectFn = exports.connectorsMoodleConnectFn = exports.connectorsMoodleStatusFn = exports.edConnectorTestFn = exports.edConnectorDisconnectFn = exports.edConnectorConnectFn = exports.edConnectorStatusFn = exports.generateTitleFn = exports.answerWithRagHttp = exports.indexChunksHttp = exports.answerWithRagFn = exports.indexChunksFn = exports.ping = exports.onMessageCreate = exports.answerWithRagCore = exports.indexChunksCore = exports.generateTitleCore = exports.apertusChatFnCore = exports.setChatClient = void 0;
...
const mapContextProvider_1 = require("./map/mapContextProvider");
...
async function answerWithRagCore({ question, topK, model, summary, recentTranscript, uid, client, }) {
    ...
    if (isMapQuestion) {
        try {
            mapResult = await (0, mapContextProvider_1.getMapContext)(q);
